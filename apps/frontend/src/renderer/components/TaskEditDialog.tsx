...
export function TaskEditDialog({ task, open, onOpenChange, onSaved }: TaskEditDialogProps) {
  ...
  const handlePaste = useCallback(async (e: ClipboardEvent<HTMLTextAreaElement>) => {
    ...
    if (remainingSlots <= 0) {
      setError(t('edit.errorMaxImages', { count: MAX_IMAGES_PER_TASK }));
      return;
    }
    ...
    for (const item of imageItems.slice(0, remainingSlots)) {
      ...
      if (!isValidImageMimeType(file.type)) {
        setError(t('edit.errorInvalidImageType', { types: ALLOWED_IMAGE_TYPES_DISPLAY }));
        continue;
      }
      ...
      try {
        ...
        setError(t('edit.errorProcessImage'));
      }
    }
    ...
    async (e: DragEvent<HTMLTextAreaElement>) => {
      ...
      for (const file of imageFiles.slice(0, remainingSlots)) {
        ...
        try {
          ...
          setError(t('edit.errorProcessDroppedImage'));
        }
      }
  ...
  const handleSave = async () => {
    ...
    if (!description.trim()) {
      setError(t('edit.errorNoDescription'));
      return;
    }
    ...
    if (success) {
      ...
      setError(t('edit.errorSaveFailed'));
    }
        ...
        <div className="space-y-5 py-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-description" className="text-sm font-medium text-foreground">
              {t('edit.descriptionLabel')} <span className="text-destructive">*</span>
            </Label>
            <Textarea
              ref={descriptionRef}
              id="edit-description"
            ...
            <p className="text-xs text-muted-foreground">
              {t('edit.descriptionHint', { shortcut: navigator.platform.includes('Mac') ? '⌘V' : 'Ctrl+V' })}
            </p>
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-title" className="text-sm font-medium text-foreground">
              {t('edit.titleLabel')} <span className="text-muted-foreground font-normal">{t('edit.titleOptional')}</span>
            </Label>
            <Input
              id="edit-title"
          ...
          <button
            ...
            disabled={isSaving}
          >
            <span>{t('edit.classification')}</span>
            {showAdvanced ? (
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="edit-category" className="h-9">
                      <SelectValue placeholder={t('edit.categoryPlaceholder')} />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="edit-complexity" className="h-9">
                      <SelectValue placeholder={t('edit.complexityPlaceholder')} />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="edit-impact" className="h-9">
                      <SelectValue placeholder={t('edit.impactPlaceholder')} />
                    </SelectTrigger>
                    <SelectContent>
          ...
          <div className="flex items-start gap-3 p-4 rounded-lg border border-border bg-muted/30">
            ...
            <div className="flex-1 space-y-1">
              ...
              >
                {t('edit.requireReview')}
              </Label>
              <p className="text-xs text-muted-foreground">
                {t('edit.requireReviewHint')}
              </p>
            </div>
          </div>
